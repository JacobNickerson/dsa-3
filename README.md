...
<h3 align="center">project_title</h3>
  ...
  <p align="center">
    project_description
    <br />
    <a href="https://github.com/jacobnickerson/dsa-3"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/jacobnickerson/dsa-3">View Demo</a>
    ·
...
Here's a blank template to get started. To avoid retyping too much info, do a search and replace with your text editor for the following: `jacobnickerson`, `dsa-3`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`, `project_license`
...
2. Clone the repo
   ```sh
   git clone https://github.com/jacobnickerson/dsa-3.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin jacobnickerson/dsa-3
...
See the [open issues](https://github.com/jacobnickerson/dsa-3/issues) for a full list of proposed features (and known issues).
...
[license-shield]: https://img.shields.io/github/license/jacobnickerson/dsa-3.svg?style=for-the-badge
[license-url]: https://github.com/jacobnickerson/dsa-3/blob/master/LICENSE.txt
